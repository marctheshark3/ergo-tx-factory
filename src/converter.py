...
class ConvertTokens:
    ...
    def get_miner_id(self, wallet):
        ...
        try:
            miner_id = self.reader.get_token_description(token)
    ...
    def create_conversion(self, miner_id, price_conversion, payout):
        ...
        for item in miner_id['tokens']:  
            ...
            try:
                ...
                conversions['ERGO'] += ratio / 100 # if this the case then lets put use this amount of erg that would be been swapped back into our erg pile
        return conversions

    def execute(self, wallet, payout):
